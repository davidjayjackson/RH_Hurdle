---
title: "Monthly AAVSO sunspots with Hurdle model"
author: "Mark Heiple..."
...
y = msts(da2$s, seasonal.periods = freqs)
...
cat("\n\n")
plot_fit(f,ds,first=1200,main="S Monthly, First 1200")
cat("\n\n")
plot_fit(f,ds,first=400,main="S Monthly, First 400")
cat("\n\n")
plot_fit(f,ds,first=129,main="S Monthly, First 129")
